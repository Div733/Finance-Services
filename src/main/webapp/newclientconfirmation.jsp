<%@page import="com.cjc.main.model.Newclient"%>
...
<div class="se-pre-con"></div>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <!--// top-bar -->
            <%List<Newclient> list=(List<Newclient>)request.getAttribute("list"); 
            ...
            <div class="container-fluid">
                <div class="row">
                    <!-- Stats -->
                    <table border="1">
                    <tr><th>Client Name</th><th>Client address</th><th>Client mobileno</th><th>Client income</th><th>previous loan</th><th>previous loan status</th><th>Duration(months)</th><th>EMI Amount</th><th>Approved By</th><th>Loan AMount</th><th>Button</th></tr>
                    
                    
                    <%for(Newclient ll:list) 
                    {	
                    %>
                    <tr>
                    <td><%out.print(ll.getNcname());%></td>
                    <td><%out.print(ll.getNcaddress());%></td>
                    <td><% out.print(ll.getNcmobileno());%></td>
                    <td><%out.print(ll.getNcincome());%></td>
                    <td><%out.print(ll.getNcpreviousloan());%></td>
                    <td><% out.print(ll.getNcpreviousloanstatus());%></td>
                    <td><%out.print(ll.getNcloanemi());%></td>
                    <td><% out.print(ll.getNcloanemiamount());%></td>
                    <td><%out.print(ll.getNcstatus());%></td>
                    <td><%out.print(ll.getNcloanamount());%></td>
                    
                       
                    <input type="hidden" value="${ll.getNcid()}">
                    <td><input type="submit" value="Confirm" style="color: red;" onclick="confirm('<%=ll.getNcid()%>')"></td>
                    </tr>
                    <% }%>
